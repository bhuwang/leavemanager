            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name">Position Name:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:positionInstance, field:'positionName')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Position Description:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:positionInstance, field:'positionDescription')}</td>
