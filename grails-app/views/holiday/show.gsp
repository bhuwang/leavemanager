                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:holidayInstance, field:'description')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:holidayInstance, field:'fromDate')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Holiday Name:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:holidayInstance, field:'holidayName')}</td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:holidayInstance, field:'thruDate')}</td>
