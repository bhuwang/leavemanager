...
<html>
    <head>
        ...
        <title>Create LeaveApplication</title>         
    </head>
    <body>
        <div class="nav">
                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:leaveApplicationInstance,field:'endDate','errors')}">
                                    <g:datePicker name="endDate" value="${leaveApplicationInstance?.endDate}" precision="day" ></g:datePicker>
                                </td>
                            </tr> 
