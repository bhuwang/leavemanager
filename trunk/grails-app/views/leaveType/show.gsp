                ...
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value">${fieldValue(bean:leaveTypeInstance, field:'description')}</td>
                            
                        </tr>
                    
                        <tr class="prop">
                            <td valign="top" class="name">Number Of Days:</td>
                            
                            <td valign="top" class="value">${fieldValue(bean:leaveTypeInstance, field:'numberOfDays')}</td>
